            ...
            <tbody>
              ...
              <template v-else>
                <tr v-for="skill in paginatedSkills" :key="skill.id" class="hover-row">
                  ...
                  <td class="text-end">
                    <div class="action-btns">
                      <button class="action-icon" @click="handleView(skill)" title="View Details"><i
                          class="bi bi-eye"></i></button>
                      <button class="action-icon" @click="handleEdit(skill)" title="Edit"><i
                          class="bi bi-pencil"></i></button>
                      <button class="action-icon delete" @click="handleDelete(skill)" title="Delete"><i
...
watch([showFormModal, showDetailsModal, showDeleteModal], (v) => {
