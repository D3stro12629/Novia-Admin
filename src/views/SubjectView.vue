            ...
            <tbody>
              ...
              <template v-else>
                <tr v-for="subject in paginatedSubjects" :key="subject.id" class="hover-row">
                  ...
                  <td class="text-end">
                    <div class="action-btns">
                      <button class="action-icon" @click="handleView(subject)" title="View Details"><i
                          class="bi bi-eye"></i></button>
                      <button class="action-icon" @click="handleEdit(subject)" title="Edit"><i
                          class="bi bi-pencil"></i></button>
                      <button class="action-icon delete" @click="handleDelete(subject)" title="Delete"><i
