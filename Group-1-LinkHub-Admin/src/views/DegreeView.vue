              ...
              <div class="modal-content compact-padding">
                ...
                <div class="form-body">
                  <div class="input-group-custom">
                    ...
                    <input v-model="form.name" placeholder="e.g. Bachelor of Computer Science" :class="{ 'has-error': errors.name }" @blur="validate('name')" />
            ...
            <div class="modal-surface compact-modal">
              ...
              <div class="modal-content compact-padding">
                ...
                <div class="modal-footer-refined">
                  ...
                  <button class="btn-danger" :disabled="degreeStore.isProcessing" @click="confirmDelete">Yes, Delete</button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="modal-surface compact-modal">
              ...
              <div class="modal-content compact-padding">
                ...
                <div class="info-grid-simple">
                  <div class="info-box full"><label>Designation Name</label><p class="large-text">{{ selectedItem?.name }}</p></div>
...
// Lifecycle
onMounted(() => degreeStore.fetchDegrees())
...
.stat-data .label { display: block; color: var(--text-muted); font-size: 0.75rem; font-weight: 600; text-transform: uppercase; }
...
.delete-warning { text-align: center; background: rgba(239, 68, 68, 0.05); padding: 1rem; border-radius: 12px; color: #fca5a5; margin-bottom: 1rem; }
